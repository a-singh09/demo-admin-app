  ...
  return (
    <>
      ...
      >
        ...
        <main id="page-content" className="flex flex-auto flex-col max-w-full pt-16 p-2 sm:p-10 space-y-6">
          {/* <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between max-w-10xl mx-auto p-4 lg:p-8 w-full">
            
          </div> */}
          <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 max-w-full mt-10">
