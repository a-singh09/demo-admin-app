...
export default function DarkSidebarBoxedContent() {
    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="overflow-y-auto">
                        <div className="p-4 w-full">
                            <nav className="space-y-1">
                                <a href="#" className="group flex items-center space-x-2 px-2.5 text-sm font-medium rounded-lg text-gray-900 border border-rose-100 bg-rose-50 dark:text-white dark:bg-gray-700/75 dark:border-transparent">
                                    ...
                                    <span className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-rose-200 text-rose-700 bg-rose-100 dark:text-rose-50 dark:bg-rose-700 dark:border-rose-700">3</span>
                                </a>
                                ...
                                <a href="#" className="group flex items-center space-x-2 px-2.5 text-sm font-medium rounded-lg text-gray-800 border border-transparent hover:text-gray-900 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700/75 dark:active:border-gray-600">
                                    ...
                                    <span className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-rose-200 text-rose-700 bg-rose-100 dark:text-rose-50 dark:bg-rose-700 dark:border-rose-700">99+</span>
                                </a>
                                <a href="#" className="group flex items-center space-x-2 px-2.5 text-sm font-medium rounded-lg text-gray-800 border border-transparent hover:text-gray-900 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700/75 dark:active:border-gray-600">
                                    <span className="flex-none flex items-center text-gray-400 group-hover:text-rose-500 dark:text-gray-500 dark:group-hover:text-gray-300">
                                    ...
                                    <span className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-rose-200 text-rose-700 bg-rose-100 dark:text-rose-50 dark:bg-rose-700 dark:border-rose-700">9</span>
                                </a>
                                <a href="#" className="group flex items-center space-x-2 px-2.5 text-sm font-medium rounded-lg text-gray-800 border border-transparent hover:text-gray-900 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700/75 dark:active:border-gray-600">
                                    <span className="flex-none flex items-center text-gray-400 group-hover:text-rose-500 dark:text-gray-500 dark:group-hover:text-gray-300">
                                    ...
                                    <span className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-rose-200 text-rose-700 bg-rose-100 dark:text-rose-50 dark:bg-rose-700 dark:border-rose-700">26</span>
                                </a>
                                <a href="#" className="group flex items-center space-x-2 px-2.5 text-sm font-medium rounded-lg text-gray-800 border border-transparent hover:text-gray-900 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700/75 dark:active:border-gray-600">
                                    <span className="flex-none flex items-center text-gray-400 group-hover:text-rose-500 dark:text-gray-500 dark:group-hover:text-gray-300">
                ...
                >
                    <div className="flex justify-between container xl:max-w-7xl mx-auto px-4 lg:px-8 w-full">
                        {/* Left Section */}
                ...
                <main id="page-content" className="flex flex-auto flex-col max-w-full pt-16">
                    ...
                    <div className="container xl:max-w-7xl mx-auto p-4 lg:p-8 w-full">
                        ...
                        <form className="space-y-6 dark:text-gray-100">
                            ...
                            {/* Multiple Select Box */}
                            <div className="space-y-1">
                                <label htmlFor="select_multiple" className="font-medium">Select Multiple</label>
                                <select id="select_multiple" name="select_multiple" multiple className="w-full block border px-3 py-2 leading-6 rounded-lg border-gray-200 focus:border-rose-500 focus:ring focus:ring-rose-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-rose-500">
                                    <option>Vue.js</option>
                                    <option>React</option>
                                    <option>Angular</option>
                                    <option>Svelte</option>
                ...
                <footer id="page-footer" className="flex flex-none items-center bg-white dark:bg-gray-800 dark:bg-opacity-50">
                    <div className="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm container xl:max-w-7xl mx-auto px-4 lg:px-8 w-full">
                        <div className="pt-4 pb-1 md:pb-4">
                            <a href="https://tailkit.com" target="_blank" className="font-medium text-rose-600 hover:text-rose-400 dark:text-rose-400 dark:hover:text-rose-300">Tailkit</a> ©
                        </div>
                        <div className="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
                            ...
                            <span>by <a href="https://pixelcave.com" target="_blank" className="font-medium text-rose-600 hover:text-rose-400 dark:text-rose-400 dark:hover:text-rose-300">pixelcave</a></span>
                        </div>
                    </div>
                </footer>
                {/* END Page Footer */}
